package com.tepia.arcgismap.googlemap;
...
/**
 * @author Mr Huang 2018/4/19
 * @version 1.0
 */
public class GoogleTiteLayer {
    ...
    private static int wkid = 102100;
    ...
    private static String URL_IMAGE = "http://{subDomain}.google.cn/maps/vt?lyrs=s@748&gl=cn&x={col}&y={row}&z={level}";
    private static String URL_IMAGE_ANNOTATION = "http://{subDomain}.google.cn/maps/vt?lyrs=h@748&gl=cn&x={col}&y={row}&z={level}";

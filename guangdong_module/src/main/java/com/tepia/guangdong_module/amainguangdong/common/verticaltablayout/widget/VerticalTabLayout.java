...
import com.tepia.guangdong_module.amainguangdong.common.verticaltablayout.adapter.TabAdapter;
import com.tepia.guangdong_module.amainguangdong.common.verticaltablayout.util.DisplayUtil;
import com.tepia.guangdong_module.amainguangdong.common.verticaltablayout.util.TabFragmentManager;
                ...
                public void run() {
                    ...
                    if (direction > 0) {
                        startAnime = ValueAnimator.ofFloat(mIndicatorBottomY, targetBottom)
                                .setDuration(300);
                        startAnime.setInterpolator(new OvershootInterpolator(1.5f));
                        ...
                        endAnime = ValueAnimator.ofFloat(mIndicatorTopY, targetTop).setDuration(300);
                        endAnime.setInterpolator(new OvershootInterpolator(1.5f));
                        ...
                        startAnime = ValueAnimator.ofFloat(mIndicatorTopY, targetTop).setDuration(300);
                        startAnime.setInterpolator(new OvershootInterpolator(1.5f));
                        startAnime.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                            @Override
                            public void onAnimationUpdate(ValueAnimator animation) {
                        ...
                        endAnime = ValueAnimator.ofFloat(mIndicatorBottomY, targetBottom).setDuration(300);
                        endAnime.setInterpolator(new OvershootInterpolator(1.5f));
                        endAnime.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                            @Override
                            public void onAnimationUpdate(ValueAnimator animation) {
                    ...
                    if (startAnime != null) {
                        ...
                        mIndicatorAnimatorSet.play(endAnime).with(startAnime);

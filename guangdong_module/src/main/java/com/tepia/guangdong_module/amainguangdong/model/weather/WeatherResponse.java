...
public class WeatherResponse extends BaseResponse {
    ...
    public WeahterBean getResult() {
        return result;
    }

    public void setResult(WeahterBean result) {
        this.result = result;
    }

...
public class AdapterTaskItemList extends BaseQuickAdapter<TaskItemBean, BaseViewHolder> {
    ...
    public AdapterTaskItemList(int layoutResId, @Nullable List<TaskItemBean> data, StartInspectionActivity activity) {

...
//        setMyLocationStyle();
    ...
    public void onLocationChanged(AMapLocation aMapLocation) {
        ...
        if (aMapLocation != null) {
            ...
            this.show(aMapLocation, "");
            if (this.is_trace_started && this.distanceListen != null) {
                this.distanceListen.getDistance(this.sumDistance_m);
            }
            ...
            if (aMapLocation.getErrorCode() == 0) {
                ...
                if (this.locationListen != null) {
                    this.locationListen.getCurrentGaodeLocation(aMapLocation);
                }
            }
        }
